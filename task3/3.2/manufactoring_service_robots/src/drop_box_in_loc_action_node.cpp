...
class DropBoxInLoc : public plansys2::ActionExecutorClient
{
public:
  DropBoxInLoc()
  : plansys2::ActionExecutorClient("dropboxinloc", 250ms)
  {
    progress_ = 0.0;
  }
...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<DropBoxInLoc>();

  node->set_parameter(rclcpp::Parameter("action_name", "DROPBOXINLOC"));
