...
class MoveRobotWarehouse : public plansys2::ActionExecutorClient
{
public:
  MoveRobotWarehouse()
  : plansys2::ActionExecutorClient("moverobotwarehouse", 250ms)
  {
    progress_ = 0.0;
  }
...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<MoveRobotWarehouse>();

  node->set_parameter(rclcpp::Parameter("action_name", "MOVEROBOTWAREHOUSE"));
