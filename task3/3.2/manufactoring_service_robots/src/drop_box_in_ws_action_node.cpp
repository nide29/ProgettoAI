...
class DropBoxInWs : public plansys2::ActionExecutorClient
{
public:
  DropBoxInWs()
  : plansys2::ActionExecutorClient("dropboxinws", 250ms)
  {
    progress_ = 0.0;
  }
...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<DropBoxInWs>();

  node->set_parameter(rclcpp::Parameter("action_name", "DROPBOXINWS"));
