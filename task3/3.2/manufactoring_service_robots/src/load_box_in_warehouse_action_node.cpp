...
class LoadBoxInWarehouse : public plansys2::ActionExecutorClient
{
public:
  LoadBoxInWarehouse()
  : plansys2::ActionExecutorClient("loadboxinwarehouse", 250ms)
  {
    progress_ = 0.0;
  }
...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<LoadBoxInWarehouse>();

  node->set_parameter(rclcpp::Parameter("action_name", "LOADBOXINWAREHOUSE"));
