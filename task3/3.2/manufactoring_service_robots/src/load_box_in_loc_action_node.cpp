...
class LoadBoxInLoc : public plansys2::ActionExecutorClient
{
public:
  LoadBoxInLoc()
  : plansys2::ActionExecutorClient("loadboxinloc", 250ms)
  {
    progress_ = 0.0;
  }
...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<LoadBoxInLoc>();

  node->set_parameter(rclcpp::Parameter("action_name", "LOADBOXINLOC"));
